export default function Hospital() {
    return (
        <svg width="680" height="520" viewBox="0 0 680 520" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="100" y="240" width="480" height="230" rx="2" fill="#f0f0f0" stroke="#d0d0d0" strokeWidth="1" />
            <rect x="210" y="140" width="260" height="100" fill="#f0f0f0" />

            <g fill="#c8e6f0" stroke="#333333" strokeWidth="1.5">
            ...
            <rect x="240" y="160" width="85" height="60" rx="2" fill="#c8e6f0" stroke="#9ab8c8" strokeWidth="1" />
            <rect x="355" y="160" width="85" height="60" rx="2" fill="#c8e6f0" stroke="#9ab8c8" strokeWidth="1" />

            <path d="M 280 310 L 280 470 L 400 470 L 400 310" stroke="#333333" strokeWidth="6" strokeLinejoin="round" fill="none" />
            ...
            <text x="340" y="278" textAnchor="middle" dominantBaseline="central" fontFamily="Arial, Helvetica, sans-serif" fontSize="34" fontWeight="800" fill="white">HOSPITAL</text>
